...
public class Måltider {
    ...
    // Konstruktører
    public Måltider(String navn, int tilberedningstid) {
        this.navn = navn;
   ...
   @Override
    ...
    public static String visMeny() {
        ...
        meny.append(new Måltider("Pizza", 30).toString()).append("\n");
        meny.append(new Måltider("Vegetarburger", 15).toString()).append("\n");
        meny.append(new Måltider("Kyllingsalat", 15).toString()).append("\n");
        meny.append(new Måltider("Biff med poteter", 20).toString()).append("\n");
